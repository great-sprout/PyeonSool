...
class ReviewApiControllerTest {
    ...
    @Nested
    class CancelRecommendReviewTest {
        @Test
        void should_Success() throws Exception {
            //given
            MockHttpSession session = new MockHttpSession();
            ...
            //when
            //then
            mvc.perform(delete("/reviews/2/recommend")
                            .session(session)
                            .contentType(MediaType.APPLICATION_JSON)
                            .accept(MediaType.APPLICATION_JSON)
                            .characterEncoding("UTF-8"))
        ...
        void should_Fail_When_ReviewIdIsNotPositive() throws Exception {
            ...
            //when
            //then
            mvc.perform(delete("/reviews/0/recommend")
                            .session(session)
                            .contentType(MediaType.APPLICATION_JSON)
                            .accept(MediaType.APPLICATION_JSON)
                            .characterEncoding("UTF-8"))
    ...
    @Nested
    class CancelNotRecommendReviewTest {
        @Test
        void should_Success() throws Exception {
            //given
            MockHttpSession session = new MockHttpSession();
            ...
            //when
            //then
            mvc.perform(delete("/reviews/2/not-recommend")
                            .session(session)
                            .contentType(MediaType.APPLICATION_JSON)
                            .accept(MediaType.APPLICATION_JSON)
                            .characterEncoding("UTF-8"))
        ...
        void should_Fail_When_ReviewIdIsNotPositive() throws Exception {
            ...
            //when
            //then
            mvc.perform(delete("/reviews/0/not-recommend")
                            .session(session)
                            .contentType(MediaType.APPLICATION_JSON)
                            .accept(MediaType.APPLICATION_JSON)
                            .characterEncoding("UTF-8"))
